...
# (Debian) chromium and ungoogled-chromium package source trees, with
...
original: $UG_PROJECT/patches
 package: $UG_CHROMIUM/debian/patches/ungoogled
...
END
	...
	| while read patch
	  do
		...
		b="$UG_CHROMIUM/debian/patches/ungoogled/$patch"
